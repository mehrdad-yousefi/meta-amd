...
DEPENDS += "boost fltk gtk+ libglu libtinyxml"
RDEPENDS_${PN} += "gdb"
...
do_compile() {
    ...
    cp -a ${BACKEND_PWRPROFROOT}/Makefile ${S}/${OUTPUT_PREFIX}/amdtPwrProf-5.10/
    cd ${S}/${OUTPUT_PREFIX}/amdtPwrProf-5.10/
    module_do_compile
    cd ${CWD}
}
