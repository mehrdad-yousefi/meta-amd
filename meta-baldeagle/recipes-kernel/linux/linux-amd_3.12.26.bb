...
SRC_URI = "https://www.kernel.org/pub/linux/kernel/v3.x/linux-3.12.26.tar.xz \
           ...
           file://0052-yocto-poky-dora-10.0.0-i2c-piix4-Use-different-message-for-AMD-Auxiliary-SM.patch \
           file://0053-yocto-poky-dora-10.0.0-ACPI-Set-acpi_enforce_resources-to-ENFORCE_RESOURCES.patch"
S = "${WORKDIR}/linux-${PV}"
